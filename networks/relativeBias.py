...
class PanguModel(nn.Module):
  """Class definition of relative bias model."""

  def __init__(self, dim=192, patch_size=(2, 8, 8), device='cpu'):
    """
    Initialize relative bias Lite model.
    ...
    # Four basic layers
    self.layer1 = EarthSpecificLayerRelative(2, self.C, drop_list[:2], 6,  input_shape=[8, 93], device=device, input_resolution=(8, 93, 180))
    self.layer2 = EarthSpecificLayerRelative(6, 2*self.C, drop_list[2:], 12, input_shape=[8, 46], device=device, input_resolution=(8, 46, 90))
    self.layer3 = EarthSpecificLayerRelative(6, 2*self.C, drop_list[2:], 12, input_shape=[8, 46], device=device, input_resolution=(8, 46, 90))
    self.layer4 = EarthSpecificLayerRelative(2, self.C, drop_list[:2], 6,  input_shape=[8, 93], device=device, input_resolution=(8, 93, 180))
  ...
  def forward(self, input, input_surface):
    """
    Forward pass of Pangu-Lite model with relative bias term.
    ...
    # Downsample from (8, 91, 180) to (8, 91, 180)
